...
import {
  ...
  throwIfDisposed,
  timeout
} from "./chunk-DBMHTBMN.mjs";
import "./chunk-KNH4TBCF.mjs";
import {
  __commonJS,
  __esm,
  __export,
...
var require_ActionDispatcher = __commonJS({
  "node_modules/chromium-bidi/lib/cjs/bidiMapper/modules/input/ActionDispatcher.js"(exports) {
    ...
    getFrameOffset_fn = async function() {
      if (__privateGet(this, _context).id === __privateGet(this, _context).cdpTarget.id) {
        return { x: 0, y: 0 };
      }
      const { backendNodeId } = await __privateGet(this, _context).cdpTarget.cdpClient.sendCommand("DOM.getFrameOwner", { frameId: __privateGet(this, _context).id });
      const { model: frameBoxModel } = await __privateGet(this, _context).cdpTarget.cdpClient.sendCommand("DOM.getBoxModel", {
        backendNodeId
      });
  ...
  "node_modules/chromium-bidi/lib/cjs/bidiMapper/modules/context/BrowsingContextImpl.js"(exports) {
    ...
    var BrowsingContextImpl = class {
      ...
      async navigate(url, wait) {
        ...
        const commandNavigation = __privateGet(this, _navigationTracker).createPendingNavigation(url);
        const cdpNavigatePromise = (async () => {
          ...
          if (cdpNavigateResult.errorText) {
            __privateGet(this, _navigationTracker).failNavigation(commandNavigation, cdpNavigateResult.errorText);
            throw new protocol_js_1.UnknownErrorException(cdpNavigateResult.errorText);
          }
          __privateGet(this, _navigationTracker).navigationCommandFinished(commandNavigation, cdpNavigateResult.loaderId);
        ...
        const result = await Promise.race([
          ...
          __privateMethod(this, _waitNavigation, waitNavigation_fn).call(this, wait, cdpNavigatePromise),
      ...
      async reload(ignoreCache, wait) {
        ...
        const commandNavigation = __privateGet(this, _navigationTracker).createPendingNavigation(__privateGet(this, _navigationTracker).url);
        const cdpReloadPromise = __privateGet(this, _cdpTarget).cdpClient.sendCommand("Page.reload", {
          ignoreCache
        });
        const result = await Promise.race([
          // No `loaderId` means same-document navigation.
          __privateMethod(this, _waitNavigation, waitNavigation_fn).call(this, wait, cdpReloadPromise),
          // Throw an error if the navigation is canceled.
          commandNavigation.finished
        ]);
        if (result instanceof NavigationTracker_js_1.NavigationResult) {
    ...
    waitNavigation_fn = async function(wait, cdpCommandPromise) {
      switch (wait) {
        case "none":
          return;
        case "interactive":
...
var require_CdpTarget = __commonJS({
  "node_modules/chromium-bidi/lib/cjs/bidiMapper/modules/cdp/CdpTarget.js"(exports) {
    ...
    var CdpTarget = class extends EventEmitter_js_1.EventEmitter {
      #id;
      #cdpClient;
      #browserCdpClient;
      #parentCdpClient;
