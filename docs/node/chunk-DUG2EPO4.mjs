                      ...
                      return pages.map((page) => {
                        return new Proxy(page, {
                          get(pTarget, pProp, pReciever) {
                            if (pProp === "screenshot") {
                              return async (x) => {
                                return pm.customScreenShot(Object.assign(Object.assign({}, x), { path: `${testResourceConfiguration.fs}/${filepath}/butThen/` + x.path }), page);
                              };
                            } else if (pProp === "close") {
                              return () => pTarget[pProp]();
                            } else if (pProp === "mainFrame") {
    ...
    super(
      ...
      class Then extends BaseThen {
        async butThen(store, thenCB, testResource, pm) {
          return fullTestInterface.butThen(store, thenCB, testResource, pm).then((v) => {
            return v;
          }, (e) => {
            console.log(" ERROR ", e);
            throw e;
