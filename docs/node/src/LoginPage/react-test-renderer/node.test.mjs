...
var LoginPageReactTestRendererTestInterface = {
  ...
  beforeEach: async function(CComponent, props) {
    ...
    await (0, import_react_test_renderer.act)(async () => {
      elem = CComponent();
      testRenderer = import_react_test_renderer.default.create(elem);
    });
  ...
  andWhen: async function({ testRenderer, reactComponent }, whenCB, testResource, pm) {
    await (0, import_react_test_renderer.act)(async () => await whenCB(testRenderer, pm));
