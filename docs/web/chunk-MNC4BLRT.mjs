...
var getWebSocketTransportClass = async () => {
  return isNode ? (await import("./NodeWebSocketTransport-OAKJIUIK.mjs")).NodeWebSocketTransport : (await import("./BrowserWebSocketTransport-AJ3WEQWR.mjs")).BrowserWebSocketTransport;
};
