...
var require_with_selector_development = __commonJS({
  "node_modules/use-sync-external-store/cjs/use-sync-external-store-shim/with-selector.development.js"(exports) {
    ...
    (function() {
      ...
      "undefined" !== typeof __REACT_DEVTOOLS_GLOBAL_HOOK__ && "function" === typeof __REACT_DEVTOOLS_GLOBAL_HOOK__.registerInternalModuleStart && __REACT_DEVTOOLS_GLOBAL_HOOK__.registerInternalModuleStart(Error());
      var React5 = require_react(), shim = require_shim(), objectIs = "function" === typeof Object.is ? Object.is : is, useSyncExternalStore3 = shim.useSyncExternalStore, useRef3 = React5.useRef, useEffect2 = React5.useEffect, useMemo3 = React5.useMemo, useDebugValue2 = React5.useDebugValue;
...
// feature-markdown:/Users/adam/Code/kokomoBay/src/LoginPage/readme.md
var readme_default = "file:///Users/adam/Code/kokomoBay/src/LoginPage/readme.md";
...
var validateEmail = (email) => {
  const r2 = email.match(/^[^\s@]+@[^\s@]+\.[^\s@]+$/) !== null || email.match(/^[^\s@]+@[^\s@]+$/) !== null;
  return r2;
};
...
console.log("Provider", Provider_default);
console.log("app", await app_default);
...
function LoginPage() {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [
    ...
    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("form", { children: [
      ...
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { id: "invalid-email-warning", className: "warning", style: { color: "red" }, children: selection.error === "invalidEmail" ? emailwarning : "" }),
      ...
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { id: credErrorId, style: { color: "red" }, children: selection.error === "credentialFail" ? credentialFailWarning : "" }),
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("br", {}),
...
function LoginPage_default() {
  return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Provider_default, { store, children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(LoginPage, {}) });
}
