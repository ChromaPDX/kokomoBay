...
var require_with_selector_development = __commonJS({
  "node_modules/use-sync-external-store/cjs/use-sync-external-store-shim/with-selector.development.js"(exports) {
    ...
    (function() {
      ...
      "undefined" !== typeof __REACT_DEVTOOLS_GLOBAL_HOOK__ && "function" === typeof __REACT_DEVTOOLS_GLOBAL_HOOK__.registerInternalModuleStart && __REACT_DEVTOOLS_GLOBAL_HOOK__.registerInternalModuleStart(Error());
      var React7 = require_react(), shim = require_shim(), objectIs = "function" === typeof Object.is ? Object.is : is, useSyncExternalStore3 = shim.useSyncExternalStore, useRef4 = React7.useRef, useEffect3 = React7.useEffect, useMemo3 = React7.useMemo, useDebugValue2 = React7.useDebugValue;
...
function LoginPage() {
  ...
  return /* @__PURE__ */ import_react3.default.createElement("div", null, /* @__PURE__ */ import_react3.default.createElement("h2", null, "Welcome back!"), /* @__PURE__ */ import_react3.default.createElement("form", null, /* @__PURE__ */ import_react3.default.createElement(
    "input",
    {
      type: "email",
      id: emailInputId,
  ...
  ), /* @__PURE__ */ import_react3.default.createElement("p", { id: "invalid-email-warning", className: "warning" }, selection.error), /* @__PURE__ */ import_react3.default.createElement("br", null), /* @__PURE__ */ import_react3.default.createElement(
    "input",
    {
      id: passwordInputId,
      type: "password",
  ...
  ), /* @__PURE__ */ import_react3.default.createElement("p", { id: "error" }, selection.error === "credentialFail" && credentialFailWarning), /* @__PURE__ */ import_react3.default.createElement("br", null), /* @__PURE__ */ import_react3.default.createElement("button", { id: loginInputId, disabled: selection.disableSubmit, onClick: (event) => {
...
var assert$ = async (sel, utils) => {
  const x2 = await utils.$(sel);
  console.log("sel", sel);
  console.log("x", x2);
  if (x2) {
    assert(true, `'${sel}' evaluated to: ${x2}`);
  } else {
    console.log("The current html is", await utils.$("xpath//*"));
    assert(x2, `Expected ${sel} to evaluate OK, but it evaluated to: ${x2}`);
  }
};
var loginPageImplreactDom = {
  ...
  thens: {
    ...
    ThereIsAnEmailError: () => async (store2, utils) => {
      assert$("xpath//p[@id='invalid-email-warning' and contains(text(),'invalidEmail')] ", utils);
    },
    ThereIsNotAnEmailError: () => async (store2, utils) => {
...
var TesterantoComponent = ({
  ...
  const myContainer = (0, import_react4.useRef)(null);
  (0, import_react4.useEffect)(() => {
    done(myContainer.current);
  }, []);
  return import_react4.default.createElement("div", { ref: myContainer }, innerComp);
};
  ...
  loginPageImplreactDom,
  {
    beforeAll: async (reactElement, itr, tr, utils) => {
      return new Promise(async (resolve, rej) => {
        ...
        if (htmlElement) {
          const domRoot = import_react_dom2.default.createRoot(htmlElement);
    ...
    beforeEach: async ({ htmlElement, reactElement, domRoot }, initializer, artificer, testResource, utils) => {
      ...
      return new Promise((resolve, rej) => {
        const r2 = reactElement();
        const component = (0, import_react5.createElement)(
          TesterantoComponent,
          {
            innerComp: r2,
    ...
    andWhen: function(s2, whenCB, tr, utils) {
      return whenCB(s2.r, utils);
    },
    butThen: async function(s2, thenCB, tr, utils) {
      return await thenCB(s2.r, utils);
    },
    afterEach: async function(store2, ndx, artificer, utils) {
      await utils.customScreenShot({ path: "beforeUnmount.jpg" });
      await utils.writeFileSync("dump.html", store2.htmlElement.outerHTML);
      return new Promise(async (resolve, rej) => {
        await store2.domRoot.unmount();
        await utils.customScreenShot({ path: "afterUnmount.jpg" });
        await store2.r.props.store.dispatch(actions.reset());
        resolve({});
      });
    },
