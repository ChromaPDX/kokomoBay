...
var testInterface = {
  ...
  beforeEach: function(CComponent, props) {
    ...
    (0, import_react_test_renderer.act)(() => {
      component = import_react_test_renderer.default.create(import_react.default.createElement(CComponent, props, import_react.default.createElement(CComponent, props, [])));
    });
    return component;
  },
...
// ../testeranto/dist/module/src/SubPackages/react-test-renderer/jsx/web.js
...
var LoginPageReactTestRendererTestInterface = {
  butThen: async function({ testRenderer, reactComponent }, thenCB, tr, pm) {
  ...
  beforeEach: async function(CComponent, props) {
    ...
    await (0, import_react_test_renderer2.act)(async () => {
      elem = CComponent();
      testRenderer = import_react_test_renderer2.default.create(elem);
    });
    await testRenderer.root.props.store.dispatch(actions.reset());
    return { reactComponent: elem, testRenderer };
  },
  andWhen: async function({ testRenderer, reactComponent }, whenCB, testResource, pm) {
    await (0, import_react_test_renderer2.act)(async () => await whenCB(testRenderer, pm));
    testRenderer.update(reactComponent);
    return testRenderer;
  }
};
...
var web_test_default = web_default(
  {
    ...
    thens: {
      ...
      ThereIsACredentialError: () => async (component, utils) => {
      ...
      ThereIsNotACredentialError: () => (component, utils) => {
